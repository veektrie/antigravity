...
export const INDUSTRIES = [
  { name: "Restaurants & Hospitality", icon: "Utensils", desc: "Timely ingredient and fresh produce distribution." },
  { name: "E-commerce", icon: "ShoppingBag", desc: "Fast last-mile delivery for high-growth online brands." },
  { name: "Healthcare", icon: "Stethoscope", desc: "Secure medical supplies and document transport." },
  { name: "Events & Exhibitions", icon: "Ticket", desc: "Punctual setup and teardown logistics for any event." },
