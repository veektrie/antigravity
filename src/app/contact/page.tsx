    ...
    <div className="flex flex-col min-h-screen bg-[#f9f9fb]">
      ...
      <section className="py-24 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 w-full">
        <div className="bg-white rounded-[3rem] shadow-[0_20px_60px_rgba(0,0,0,0.03)] border border-black/5 overflow-hidden flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-5/12 bg-[#0b0c10] p-12 lg:p-16 flex flex-col justify-between relative overflow-hidden text-white">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#1a56ff]/20 rounded-full blur-[80px] pointer-events-none" />
            <div className="relative z-10 space-y-12">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  <div className="h-10 w-10 shrink-0 bg-[#1a56ff]/20 rounded-full flex items-center justify-center border border-[#1a56ff]/30">
                    <span className="text-lg">📍</span>
                  </div>
                  <div>
                    <p className="text-xs font-bold text-[#1a56ff] uppercase tracking-widest mb-1">Corporate HQ</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold text-[#1a56ff] uppercase tracking-widest mb-1">24/7 Dispatch</p>
            ...
            <div className="pt-20 relative z-10 w-full opacity-30 invert mix-blend-screen overflow-hidden mt-12 rounded-2xl h-40">
               <div className="absolute inset-0 bg-[#1a56ff]/10 z-10"></div>
            ...
            <form className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <input type="text" className="w-full border-b border-zinc-200 py-3 bg-transparent focus:outline-none focus:border-[#1a56ff] transition-colors text-[#0D1B3E] font-medium" placeholder="Jane Doe" />
                </div>
                <div className="space-y-3">
                  <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500">Email Address</label>
                  <input type="email" className="w-full border-b border-zinc-200 py-3 bg-transparent focus:outline-none focus:border-[#1a56ff] transition-colors text-[#0D1B3E] font-medium" placeholder="jane@company.com" />
                </div>
              </div>
              <div className="space-y-3">
                <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500">Subject / Service Needed</label>
                <input type="text" className="w-full border-b border-zinc-200 py-3 bg-transparent focus:outline-none focus:border-[#1a56ff] transition-colors text-[#0D1B3E] font-medium" placeholder="e.g. Urgent Priority Delivery" />
              </div>
              <div className="space-y-3">
                <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500">Message</label>
                <textarea rows={4} className="w-full border-b border-zinc-200 py-3 bg-transparent focus:outline-none focus:border-[#1a56ff] transition-colors text-[#0D1B3E] font-medium resize-none" placeholder="Provide tracking numbers or dispatch details..."></textarea>
              </div>
              <button type="button" className="inline-flex items-center gap-3 px-10 py-5 bg-[#1a56ff] text-white font-bold text-[11px] uppercase tracking-[0.1em] rounded-full hover:bg-blue-700 transition-all shadow-xl shadow-blue-500/20 active:scale-95">
